<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            <div
                class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white shadow-lg shadow-indigo-500/30">
    ...
    <div class="grid gap-6 lg:grid-cols-3">
        ...
        <div class="lg:col-span-1">
            <div class="overflow-hidden rounded-2xl bg-white shadow-lg shadow-gray-200/50 border border-gray-100">
                ...
                <form action="{{ route('commission.update') }}" method="POST" class="p-5" x-data="{ type: '{{ $user->commission_type }}' }">
                    ...
                    <div
                        class="mb-6 rounded-xl bg-gradient-to-br from-indigo-50 to-purple-50 p-5 border border-indigo-100">
                    ...
                    <div class="mb-5 space-y-3">
                        ...
                        <div class="space-y-3">
                            <label
                                ...
                                :class="type === 'fixed' ? 'border-indigo-500 bg-indigo-50 shadow-lg shadow-indigo-500/10' :
                    ...
                    <div class="mb-5 space-y-2">
                        ...
                        <div class="relative">
                            <span x-show="type === 'fixed'"
                                class="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-500 font-semibold">৳</span>
                            <span x-show="type === 'percentage'"
                                class="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-500 font-semibold">%</span>
                            <input type="number" name="commission_rate" id="commission_rate"
                                value="{{ old('commission_rate', $user->default_commission_rate) }}" step="0.01"
                                min="0" :max="type === 'percentage' ? 100 : 10000"
                    ...
                    {{-- Info Box --}}
                    <div
                        class="mb-5 rounded-xl bg-gradient-to-br from-amber-50 to-yellow-50 p-4 border border-amber-200">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-4">
                <div
                    class="overflow-hidden rounded-2xl bg-white shadow-lg shadow-gray-200/50 border border-gray-100 p-5 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <div class="flex items-center gap-4">
                <form method="GET" class="flex items-center gap-3">
                    ...
                    <button type="submit"
                        class="rounded-xl bg-gray-100 px-5 py-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-200 transition-colors">
                        View
                    </button>
                </form>
            </div>
                ...
                @else
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th
                                    class="px-4 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500">
                                    Lead</th>
                                <th
                                    class="px-4 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500">
                                    Date</th>
                                <th
                                    class="px-4 py-4 text-right text-xs font-bold uppercase tracking-wider text-gray-500">
                                    Deal Value</th>
                                <th
                                    class="px-4 py-4 text-center text-xs font-bold uppercase tracking-wider text-gray-500">
                                    Rate</th>
                                <th
                                    class="px-4 py-4 text-right text-xs font-bold uppercase tracking-wider text-gray-500">
                                    Commission</th>
                                ...
                                @if ($conversion->lead)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="whitespace-nowrap px-4 py-4 text-center">
                                            <span
                                                class="inline-flex items-center rounded-lg px-2.5 py-1 text-xs font-semibold bg-gray-100 text-gray-700">
                                        ...
                                        <td
                                            class="whitespace-nowrap px-4 py-4 text-right text-sm font-bold text-emerald-600">
                        ...
                        <tfoot class="bg-gradient-to-r from-gray-50 to-gray-100">
                            <tr>
                                <td colspan="4" class="px-4 py-4 text-right text-sm font-bold text-gray-700">Total:
                                </td>
            ...
            <div class="overflow-x-auto">
                ...
                @else
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @foreach ($breakdown['extra_commissions'] as $extra)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="whitespace-nowrap px-4 py-4">
                                        <span
                                            class="inline-flex items-center rounded-lg px-2.5 py-1 text-xs font-semibold bg-purple-100 text-purple-700">
                                    ...
                                    <td
                                        class="whitespace-nowrap px-4 py-4 text-right text-sm font-bold text-purple-600">
                        ...
                        <tfoot class="bg-gradient-to-r from-gray-50 to-gray-100">
                            <tr>
                                <td colspan="4" class="px-4 py-4 text-right text-sm font-bold text-gray-700">
                                    Approved Total:</td>
                            ...
                            @if ($breakdown['pending_extra'] > 0)
                                <tr>
                                    <td colspan="4" class="px-4 py-4 text-right text-sm font-bold text-amber-600">
                                        Pending:</td>
