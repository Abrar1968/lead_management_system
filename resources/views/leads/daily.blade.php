<x-app-layout>
    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
            {{-- Date Navigation --}}
            <div
                class="relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg shadow-gray-200/50 border border-gray-100">
                ...
                <div class="relative flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div class="text-center">
                        <div class="flex items-center justify-center gap-3">
                            <div
                                class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-lg shadow-blue-500/30">
                        ...
                        @if ($dateNav['is_today'])
                            <span
                                class="mt-3 inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 px-4 py-1 text-xs font-semibold text-white shadow-lg shadow-emerald-500/30">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <div class="relative">
                    <input type="date" value="{{ $dateNav['current'] }}" max="{{ now()->format('Y-m-d') }}"
            ...
            <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
                <div
                    class="group relative overflow-hidden rounded-2xl bg-white p-5 shadow-lg shadow-gray-200/50 border border-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    <div
                        class="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-gradient-to-br from-gray-500/10 to-gray-600/10 transition-transform duration-300 group-hover:scale-110">
                    </div>
                    <div class="relative">
                        <div class="flex items-center gap-3">
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-gray-500 to-gray-700 shadow-lg shadow-gray-500/30">
                ...
                <div
                    class="group relative overflow-hidden rounded-2xl bg-white p-5 shadow-lg shadow-gray-200/50 border border-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    <div
                        class="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-gradient-to-br from-blue-500/10 to-blue-600/10 transition-transform duration-300 group-hover:scale-110">
                    </div>
                    <div class="relative">
                        <div class="flex items-center gap-3">
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-blue-700 shadow-lg shadow-blue-500/30">
                                <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    class="group relative overflow-hidden rounded-2xl bg-white p-5 shadow-lg shadow-gray-200/50 border border-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    <div
                        class="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-gradient-to-br from-emerald-500/10 to-emerald-600/10 transition-transform duration-300 group-hover:scale-110">
                    </div>
                    <div class="relative">
                        <div class="flex items-center gap-3">
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-700 shadow-lg shadow-emerald-500/30">
                                <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    class="group relative overflow-hidden rounded-2xl bg-white p-5 shadow-lg shadow-gray-200/50 border border-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                    <div
                        class="absolute -right-4 -top-4 h-24 w-24 rounded-full bg-gradient-to-br from-amber-500/10 to-orange-600/10 transition-transform duration-300 group-hover:scale-110">
                    </div>
                    <div class="relative">
                        <div class="flex items-center gap-3">
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 shadow-lg shadow-amber-500/30">
                                <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div>
                                <div class="text-2xl font-bold text-amber-600">{{ $summary['pending_followups'] }}
                                </div>
            ...
            <div x-data="{ showFilters: false }" class="relative">
                <button @click="showFilters = !showFilters"
                    ...
                    <div
                        class="flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br from-violet-500 to-purple-600 text-white">
                    ...
                    Filters
                    <svg class="h-5 w-5 transition-transform duration-300" :class="showFilters ? 'rotate-180' : ''"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
                </button>

                <form x-show="showFilters" x-transition:enter="transition ease-out duration-300"
                    x-transition:enter-start="opacity-0 -translate-y-4"
                    x-transition:enter-end="opacity-100 translate-y-0"
                    x-transition:leave="transition ease-in duration-200"
                    x-transition:leave-start="opacity-100 translate-y-0"
                    x-transition:leave-end="opacity-0 -translate-y-4" method="GET"
                    ...
                    <div class="grid grid-cols-2 gap-4 sm:grid-cols-5">
                        <div class="space-y-2">
                            ...
                            <select name="source"
                                class="w-full rounded-xl border-gray-200 bg-gray-50 text-sm font-medium text-gray-700 transition-all duration-200 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-500/20">
                                <option value="all">All Sources</option>
                                <option value="WhatsApp" {{ $filters['source'] === 'WhatsApp' ? 'selected' : '' }}>
                                    WhatsApp</option>
                                <option value="Messenger" {{ $filters['source'] === 'Messenger' ? 'selected' : '' }}>
                                    Messenger</option>
                                <option value="Website" {{ $filters['source'] === 'Website' ? 'selected' : '' }}>
                                    Website</option>
                            </select>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="service"
                                ...
                                <option value="Website" {{ $filters['service'] === 'Website' ? 'selected' : '' }}>
                                    Website</option>
                                <option value="Software" {{ $filters['service'] === 'Software' ? 'selected' : '' }}>
                                    Software</option>
                                <option value="CRM" {{ $filters['service'] === 'CRM' ? 'selected' : '' }}>CRM
                                </option>
                                <option value="Marketing" {{ $filters['service'] === 'Marketing' ? 'selected' : '' }}>
                                    Marketing</option>
                            </select>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="status"
                                ...
                                <option value="New" {{ $filters['status'] === 'New' ? 'selected' : '' }}>New
                                </option>
                                <option value="Contacted" {{ $filters['status'] === 'Contacted' ? 'selected' : '' }}>
                                    Contacted</option>
                                <option value="Qualified" {{ $filters['status'] === 'Qualified' ? 'selected' : '' }}>
                                    Qualified</option>
                                <option value="Negotiation"
                                    {{ $filters['status'] === 'Negotiation' ? 'selected' : '' }}>Negotiation</option>
                                <option value="Converted" {{ $filters['status'] === 'Converted' ? 'selected' : '' }}>
                                    Converted</option>
                                <option value="Lost" {{ $filters['status'] === 'Lost' ? 'selected' : '' }}>Lost
                                </option>
                            </select>
                        </div>
            ...
            @if ($leads->isEmpty())
                <div
                    class="overflow-hidden rounded-2xl bg-white p-12 text-center shadow-lg shadow-gray-200/50 border border-gray-100">
                    <div
                        class="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200">
            ...
            @else
                <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ($leads as $lead)
                        <div
                            class="group relative overflow-hidden rounded-2xl bg-white shadow-lg shadow-gray-200/50 border border-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                            {{-- Priority Indicator --}}
                            <div class="absolute right-0 top-0 h-20 w-20 overflow-hidden">
                                <div
                                    class="absolute right-[-35px] top-[12px] w-[100px] rotate-45 py-1 text-center text-[10px] font-bold uppercase tracking-wider
                            ...
                            <div class="p-5">
                                ...
                                <div class="flex items-start justify-between pr-10">
                                    ...
                                    <div class="flex gap-2 ml-2" x-data="{ showFollowUpForm: false, showMeetingForm: false }">
                                        ...
                                        <div class="relative">
                                            ...
                                            <div x-show="showFollowUpForm" @click.outside="showFollowUpForm = false"
                                                x-cloak
                                ...
                                <div class="mt-4 space-y-2">
                                    ...
                                    @if ($lead->email)
                                        <div class="flex items-center gap-2 text-sm text-gray-600">
                                            <span
                                                class="flex h-7 w-7 items-center justify-center rounded-lg bg-purple-100 text-purple-600">
                                                <svg class="h-4 w-4" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                ...
                                @if ($lead->initial_remarks)
                                    <div class="mt-3 rounded-lg bg-blue-50 px-3 py-2 border-l-4 border-blue-500">
                                        <div class="flex items-start gap-2">
                                            <svg class="h-4 w-4 mt-0.5 text-blue-600 flex-shrink-0" fill="none"
                                                stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
                                            </svg>
                                            <p class="text-xs text-gray-700 leading-relaxed">
                                                {{ $lead->initial_remarks }}</p>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="mt-4 flex flex-wrap gap-2">
                                    <span
                                        class="inline-flex items-center gap-1 rounded-lg bg-gradient-to-r from-emerald-500 to-green-600 px-2.5 py-1 text-xs font-semibold text-white shadow-sm">
                                        <svg class="h-3 w-3" fill="currentColor" viewBox="0 0 24 24">
                                            ...
                                            @elseif($lead->source === 'Messenger')
                                                <path
                                                    d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.614 4.469 8.654V24l4.088-2.242c1.092.3 2.246.464 3.443.464 6.627 0 12-4.974 12-11.111S18.627 0 12 0zm1.191 14.963l-3.055-3.26-5.963 3.26L10.732 8l3.131 3.259L19.752 8l-6.561 6.963z" />
                                            @else
                                                <path
                                        ...
                                        @if ($latestFollowUp)
                                            <div
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <span
                                                        class="flex h-6 w-6 items-center justify-center rounded-lg bg-amber-100 text-amber-600">
                                                    ...
                                                    @else
                                                        <span
                                                            class="inline-flex items-center rounded-full px-2 py-0.5 text-xs font-semibold {{ $latestFollowUp->status === 'Completed' ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700' }}">
                                                ...
                                                @if ($latestFollowUp->price)
                                                    <span
                                                        class="text-xs font-bold text-emerald-600">৳{{ number_format($latestFollowUp->price, 0) }}</span>
                                                @endif
                                            </div>
                                        @endif
                                        @if ($latestMeeting)
                                            <div
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <span
                                                        class="flex h-6 w-6 items-center justify-center rounded-lg bg-blue-100 text-blue-600">
                                                        <svg class="h-3.5 w-3.5" fill="none" stroke="currentColor"
                                                            viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"
                                                ...
                                                @if ($latestMeeting->price)
                                                    <span
                                                        class="text-xs font-bold text-emerald-600">৳{{ number_format($latestMeeting->price, 0) }}</span>
                                                @endif
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="mt-4 flex items-center justify-between border-t border-gray-100 pt-4">
                                    <div class="flex items-center gap-2 text-sm">
                                        ...
                                        <span
                                            class="font-medium text-gray-700">{{ $lead->assignedTo?->name ?? 'Unassigned' }}</span>
                                    </div>
                                    <div class="flex items-center gap-3">
                                        @if ($lead->initial_remarks)
                                            <div class="group relative inline-block">
                                                <svg class="h-5 w-5 text-gray-400 hover:text-blue-500 cursor-help"
                                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                                        d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
                                                ...
                                                <div
                                                    class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden w-48 rounded-lg bg-gray-900 p-2 text-xs text-white shadow-lg group-hover:block z-50">
                                                    {{ $lead->initial_remarks }}
                                                    <div
                                                        class="absolute -bottom-1 left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-900">
                                                    </div>
                                                </div>
                                            </div>
                                        @else
                                        ...
                                        @if ($lead->followUps->where('status', 'Pending')->count() > 0)
                                            <span class="flex items-center gap-1 text-sm text-amber-500"
                                                ...
                                                <span
                                                    class="font-semibold">{{ $lead->followUps->where('status', 'Pending')->count() }}</span>
                                            </span>
                                        @endif
                                    </div>
                                </div>
