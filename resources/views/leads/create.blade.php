                        ...
                        <div>
                            ...
                            <select name="service_interested" id="service_interested"
                                ...
                                <option value="Website"
                                    {{ old('service_interested') === 'Website' ? 'selected' : '' }}>Website</option>
                                <option value="Software"
                                    {{ old('service_interested') === 'Software' ? 'selected' : '' }}>Software</option>
                                <option value="CRM" {{ old('service_interested') === 'CRM' ? 'selected' : '' }}>CRM
                                </option>
                                <option value="Marketing"
                                    {{ old('service_interested') === 'Marketing' ? 'selected' : '' }}>Marketing
                                </option>
                            </select>
