...
<div x-data="{
    ...
    <div x-show="show"
        class="relative z-10 mb-6 bg-white rounded-2xl overflow-hidden shadow-2xl shadow-gray-900/20 transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto border border-gray-100"
