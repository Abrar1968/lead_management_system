<x-app-layout>
    ...
    <a href="{{ route('smart-suggestions.index') }}" class="block mb-8 group">
        <div class="bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 rounded-2xl shadow-xl shadow-purple-500/30 p-6 text-white relative overflow-hidden hover:shadow-2xl hover:shadow-purple-500/40 transition-all duration-300 hover:-translate-y-1">
            ...
            <div class="relative flex items-center justify-between">
                ...
                <div class="flex items-center gap-6">
                    <div class="text-right hidden sm:block">
                        <p class="text-2xl font-bold">{{ $stats['pending_follow_ups'] + ($stats['unassigned_leads'] ?? 0) }}</p>
                        <p class="text-xs text-white/70 uppercase tracking-wider">Actions Available</p>
                    </div>
                    <svg class="w-8 h-8 text-white/70 group-hover:translate-x-2 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
