            ...
            <div class="bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl shadow-xl p-6 text-white">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold">{{ $client->conversion->conversion_date->format('M d, Y') }}</p>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 font-medium">{{ $client->conversion->lead->service?->name ?? 'N/A' }}</p>
                    </div>
                </div>
            </div>
                    ...
                    @foreach($dynamicFields as $field)
                        ...
                        <div class="{{ $field->type === 'image' ? 'md:col-span-2' : '' }}">
                            ...
                            @if($field->type === 'image' && $value)
                                <img src="{{ asset('storage/' . $value) }}" alt="{{ $field->label }}" class="mt-2 max-w-xs rounded-lg shadow">
