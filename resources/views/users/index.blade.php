<x-app-layout>
    ...
    @if (session('error'))
        <div class="mb-6 overflow-hidden rounded-2xl bg-gradient-to-r from-red-50 to-rose-50 p-4 border border-red-200 shadow-lg shadow-red-500/10">
            <div class="flex items-center gap-3">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gradient-to-r from-gray-700 to-gray-800">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-center text-xs font-bold uppercase tracking-wider text-white">Role</th>
                        <th class="px-6 py-4 text-center text-xs font-bold uppercase tracking-wider text-white">Commission</th>
                        <th class="px-6 py-4 text-center text-xs font-bold uppercase tracking-wider text-white">Leads</th>
                        <th class="px-6 py-4 text-center text-xs font-bold uppercase tracking-wider text-white">Conversions</th>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="whitespace-nowrap px-6 py-4">
                                <a href="{{ route('users.show', $user) }}" class="flex items-center gap-3 group">
                                    <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500 to-indigo-600 text-white shadow-lg shadow-purple-500/30 font-bold">
                                        {{ strtoupper(substr($user->name, 0, 1)) }}
                                    </div>
                                    <div>
                                        <p class="text-sm font-bold text-gray-900 group-hover:text-indigo-600 transition-colors">{{ $user->name }}</p>
                            ...
                            <td class="whitespace-nowrap px-6 py-4 text-center">
                                <span class="inline-flex items-center rounded-lg bg-gradient-to-r from-emerald-500 to-green-600 px-3 py-1.5 text-xs font-bold text-white shadow-sm shadow-emerald-500/30">
