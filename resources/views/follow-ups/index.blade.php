<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-3">
                <div
                    class="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-lg shadow-amber-500/30">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div
            class="group overflow-hidden rounded-2xl bg-white p-5 shadow-lg shadow-gray-200/50 border border-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            <div class="flex items-center gap-4">
                <div
                    class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-lg shadow-amber-500/30 transition-transform duration-300 group-hover:scale-110">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div
            ...
            <div class="flex items-center gap-4">
                <div
                    class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-red-500 to-rose-600 text-white shadow-lg shadow-red-500/30 transition-transform duration-300 group-hover:scale-110">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div
            ...
            <div class="flex items-center gap-4">
                <div
                    class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-lg shadow-blue-500/30 transition-transform duration-300 group-hover:scale-110">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
        ...
        <div
            ...
            <div class="flex items-center gap-4">
                <div
                    class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-green-600 text-white shadow-lg shadow-emerald-500/30 transition-transform duration-300 group-hover:scale-110">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="overflow-hidden rounded-2xl bg-white p-6 shadow-lg shadow-gray-200/50 border border-gray-100 mb-6">
        <form method="GET" class="flex flex-wrap gap-4 items-end">
            ...
            <div class="flex gap-2">
                <button type="submit"
                    class="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-amber-500 to-orange-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-amber-500/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5">
                ...
                <a href="{{ route('follow-ups.index') }}"
                    class="inline-flex items-center rounded-xl bg-gray-100 px-5 py-2.5 text-sm font-semibold text-gray-700 transition-all duration-200 hover:bg-gray-200">
                    Reset
                </a>
            </div>
        </form>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="overflow-hidden rounded-2xl bg-white shadow-lg shadow-gray-200/50 border border-gray-100">
                <div class="bg-gradient-to-r from-red-500 to-rose-600 px-5 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <span
                            class="inline-flex items-center rounded-lg bg-white/20 px-2.5 py-1 text-xs font-bold text-white">{{ $overdueFollowUps->count() }}</span>
                    </div>
                </div>
                            ...
                            <div class="px-5 py-4 transition-colors hover:bg-gray-50" x-data="{ editing: false }">
                                <div class="flex justify-between items-start">
                                    ...
                                    <div class="text-right">
                                        <p class="text-xs font-bold text-red-600">
                                            {{ $followUp->follow_up_date->format('M j') }}</p>
                                        @if ($followUp->price)
                                            <p class="text-xs font-bold text-emerald-600">
                                                ৳{{ number_format($followUp->price, 0) }}</p>
                                        @endif
                                    </div>
                                </div>
                                @if ($followUp->interest)
                                    <span
                                        class="inline-flex items-center rounded-lg px-2.5 py-1 text-xs font-semibold mt-2
                                ...
                                @if ($followUp->notes)
                                    <p class="text-xs text-gray-600 mt-2 leading-relaxed">
                                        {{ Str::limit($followUp->notes, 60) }}</p>
                                @endif
                                <div class="flex gap-2 mt-3">
                                    <button @click="editing = !editing"
                                        class="text-xs px-3 py-1.5 bg-amber-100 text-amber-700 rounded-lg font-semibold hover:bg-amber-200 transition-colors">
                                        Update
                                    </button>
                                    <a href="{{ route('leads.show', $followUp->lead) }}"
                                        class="text-xs px-3 py-1.5 bg-blue-100 text-blue-700 rounded-lg font-semibold hover:bg-blue-200 transition-colors">
                                        View Lead
                                    </a>
                                </div>
                                <!-- Inline Edit Form -->
                                <div x-show="editing" x-cloak x-transition
                                    class="mt-3 p-4 bg-gray-50 rounded-xl border border-gray-100">
                                    <form action="{{ route('follow-ups.complete', $followUp) }}" method="POST"
                                        ...
                                        <div class="grid grid-cols-2 gap-3">
                                            <div class="space-y-1">
                                                ...
                                                <select name="interest"
                                                    ...
                                                    @foreach ($interestStatuses as $key => $status)
                                                        <option value="{{ $key }}"
                                                            {{ $followUp->interest === $key ? 'selected' : '' }}>
                                                            {{ $status['label'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="space-y-1">
                                                ...
                                                <input type="number" name="price" value="{{ $followUp->price }}"
                                                    step="0.01"
                                                    class="w-full text-sm rounded-lg border-gray-200 bg-white"
                                                    placeholder="0.00">
                                            </div>
                                        ...
                                        <button type="submit"
                                            class="w-full text-sm px-4 py-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-lg font-semibold shadow-lg shadow-emerald-500/30 hover:shadow-xl transition-all">
                                            Complete Follow-up
                                        </button>
                                    </form>
                                </div>
        ...
        <!-- Today's Follow-ups -->
        <div
            class="overflow-hidden rounded-2xl bg-white shadow-lg shadow-gray-200/50 border border-gray-100 {{ $overdueFollowUps->count() == 0 ? 'lg:col-span-2' : '' }}">
            ...
            <div class="divide-y divide-gray-100 max-h-96 overflow-y-auto">
                    ...
                    @if ($followUp->lead)
                        <div class="px-5 py-4 transition-colors hover:bg-gray-50" x-data="{ editing: false }">
                            <div class="flex justify-between items-start">
                                <a href="{{ route('leads.show', $followUp->lead) }}" class="block group">
                                    <p
                                        class="font-semibold text-gray-900 group-hover:text-amber-600 transition-colors">
                                        {{ $followUp->lead->client_name }}</p>
                                    <p class="text-xs text-gray-500">{{ $followUp->lead->phone_number }}</p>
                                </a>
                                <div class="text-right">
                                    @if ($followUp->follow_up_time)
                                        <p class="text-xs font-bold text-amber-600">
                                            {{ \Carbon\Carbon::parse($followUp->follow_up_time)->format('h:i A') }}</p>
                                    @endif
                                    @if ($followUp->price)
                                        <p class="text-xs font-bold text-emerald-600">
                                            ৳{{ number_format($followUp->price, 0) }}</p>
                            ...
                            <div class="flex items-center gap-2 mt-2">
                                ...
                                @endif
                                <span
                                    class="text-xs px-2.5 py-1 rounded-lg font-semibold {{ $followUp->status === 'Completed' ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700' }}">
                                    {{ $followUp->status }}
                                </span>
                            </div>
                            @if ($followUp->notes)
                                <p class="text-xs text-gray-600 mt-2 leading-relaxed">
                                    {{ Str::limit($followUp->notes, 80) }}</p>
                            @endif
                ...
                @empty
                    <div class="px-5 py-10 text-center">
                        <div
                            class="mx-auto h-16 w-16 rounded-2xl bg-emerald-100 flex items-center justify-center mb-4">
        ...
        <!-- Upcoming Follow-ups -->
        <div
            class="overflow-hidden rounded-2xl bg-white shadow-lg shadow-gray-200/50 border border-gray-100 {{ $overdueFollowUps->count() == 0 ? 'lg:col-span-1' : '' }}">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-4 text-left text-xs font-bold uppercase tracking-wider text-gray-500">Date
                        </th>
                        ...
                        <tbody x-data="{ editing: false }" class="bg-white divide-y divide-gray-100">
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-4">
                                    @if ($followUp->interest)
                                        <span
                                            class="inline-flex items-center rounded-lg px-2.5 py-1 text-xs font-semibold {{ $interestStatuses[$followUp->interest]['bg'] ?? 'bg-gray-100' }} {{ $interestStatuses[$followUp->interest]['text'] ?? 'text-gray-800' }}">
                                            {{ $followUp->interest }}
                                        </span>
                                    @else
                                ...
                                <td class="px-4 py-4 text-sm font-bold text-emerald-600">
                                    {{ $followUp->price ? '৳' . number_format($followUp->price, 0) : '-' }}
                                </td>
                                <td class="px-4 py-4 text-sm text-gray-700">
                                    {{ $followUp->follow_up_date->format('M j, Y') }}
                                    @if ($followUp->follow_up_time)
                                        <br><span
                                            class="text-xs text-gray-400">{{ \Carbon\Carbon::parse($followUp->follow_up_time)->format('h:i A') }}</span>
                                    @endif
                                </td>
                                <td class="px-4 py-4">
                                    <span
                                ...
                                <td class="px-4 py-4 text-right">
                                    <div class="flex justify-end gap-1">
                                        ...
                                        @if ($followUp->status === 'Pending')
                                            <form action="{{ route('follow-ups.complete', $followUp) }}"
                                                method="POST" class="inline">
                                                @csrf
                                                <button type="submit"
                                                    class="text-xs px-3 py-1.5 bg-emerald-100 text-emerald-700 rounded-lg font-semibold hover:bg-emerald-200 transition-colors">✓</button>
                                            </form>
                                        @endif
                                        <form action="{{ route('follow-ups.destroy', $followUp) }}" method="POST"
                                            class="inline" onsubmit="return confirm('Delete follow-up?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                class="text-xs px-3 py-1.5 bg-red-100 text-red-700 rounded-lg font-semibold hover:bg-red-200 transition-colors">✕</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <form action="{{ route('follow-ups.update', $followUp) }}" method="POST"
                                        ...
                                        <div class="space-y-1">
                                            ...
                                            <input type="date" name="follow_up_date"
                                                value="{{ $followUp->follow_up_date->format('Y-m-d') }}"
                                                class="text-sm rounded-lg border-gray-200 bg-white">
                                        </div>
                                        <div class="space-y-1">
                                            ...
                                            <select name="status"
                                                ...
                                                <option value="Pending"
                                                    {{ $followUp->status === 'Pending' ? 'selected' : '' }}>Pending
                                                </option>
                                                <option value="Completed"
                                                    {{ $followUp->status === 'Completed' ? 'selected' : '' }}>Completed
                                                </option>
                                                <option value="Cancelled"
                                                    {{ $followUp->status === 'Cancelled' ? 'selected' : '' }}>Cancelled
                                                </option>
                                            </select>
                                        </div>
                                        <div class="flex-1 space-y-1">
                                            <label class="text-xs font-semibold text-gray-700">Notes</label>
                                            <input type="text" name="notes" value="{{ $followUp->notes }}"
                                                class="w-full text-sm rounded-lg border-gray-200 bg-white">
                                        </div>
                                        <div class="flex gap-2">
                                            <button type="submit"
                                                class="px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg">Save</button>
                                            <button type="button" @click="editing = false"
                                                class="px-4 py-2 bg-gray-200 text-gray-700 text-sm font-semibold rounded-lg">Cancel</button>
                                        </div>
                                    </form>
                                </td>
                            </tr>
