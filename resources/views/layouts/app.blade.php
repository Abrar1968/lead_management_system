    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="flex items-center justify-between h-20 px-6 border-b border-white/10">
                <div class="flex items-center space-x-3">
                    <div
                        class="w-10 h-10 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/30">
                ...
                <button @click="sidebarOpen = false"
                    class="lg:hidden p-2 text-white/60 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
            ...
            <nav class="mt-6 px-4 overflow-y-auto" style="max-height: calc(100vh - 180px);">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('dashboard') }}"
                        ...
                        <div
                            class="w-9 h-9 rounded-lg bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                    ...
                    <a href="{{ route('leads.daily') }}"
                        ...
                        <div
                            class="w-9 h-9 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <span
                            class="ml-auto bg-gradient-to-r from-emerald-400 to-teal-500 text-white text-xs px-2.5 py-1 rounded-full font-semibold shadow-sm badge-pulse">Today</span>
                    </a>
                    ...
                    <a href="{{ route('leads.monthly') }}"
                        ...
                        <div
                            class="w-9 h-9 rounded-lg bg-gradient-to-br from-indigo-500 to-blue-600 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('leads.create') }}"
                        ...
                        <div
                            class="w-9 h-9 rounded-lg bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('leads.index') }}"
                        ...
                        <div
                            class="w-9 h-9 rounded-lg bg-gradient-to-br from-slate-500 to-gray-600 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <!-- Activity Section -->
                    <div class="pt-6 mt-4">
                        <p class="px-4 text-xs text-blue-300/50 uppercase tracking-wider font-semibold mb-3">Activity
                        </p>
                        ...
                        <a href="{{ route('follow-ups.index') }}"
                            ...
                            <div
                                class="w-9 h-9 rounded-lg bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                            ...
                            @if ($pendingFollowUps > 0)
                                <span
                                    class="ml-auto bg-gradient-to-r from-red-500 to-rose-500 text-white text-xs px-2.5 py-1 rounded-full font-semibold shadow-sm badge-pulse">{{ $pendingFollowUps }}</span>
                            @endif
                        </a>
                        ...
                        <a href="{{ route('meetings.index') }}"
                            ...
                            <div
                                class="w-9 h-9 rounded-lg bg-gradient-to-br from-pink-500 to-rose-500 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            ...
                            @if ($todayMeetings > 0)
                                <span
                                    class="ml-auto bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-xs px-2.5 py-1 rounded-full font-semibold shadow-sm">{{ $todayMeetings }}</span>
                            @endif
                        </a>
                        ...
                        <a href="{{ route('contacts.index') }}"
                            ...
                            <div
                                class="w-9 h-9 rounded-lg bg-gradient-to-br from-teal-500 to-cyan-500 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            @php
                                $todayContacts = \App\Models\LeadContact::whereDate('call_date', now()->format('Y-m-d'))
                                    ...
                                    ->when(
                                        ...
                                        fn($q) => $q->whereHas(
                                            'lead',
                                            fn($lq) => $lq->where('assigned_to', auth()->id()),
                                        ),
                                    )
                                    ->count();
                            @endphp
                            @if ($todayContacts > 0)
                                <span
                                    class="ml-auto bg-gradient-to-r from-green-500 to-emerald-500 text-white text-xs px-2.5 py-1 rounded-full font-semibold shadow-sm">{{ $todayContacts }}</span>
                            @endif
                        </a>
                        ...
                        <a href="{{ route('demos.index') }}"
                            ...
                            <div
                                class="w-9 h-9 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <a href="{{ route('clients.index') }}"
                            ...
                            <div
                                class="w-9 h-9 rounded-lg bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @if (auth()->user()->isAdmin())
                        <div class="pt-6 mt-4">
                            <p class="px-4 text-xs text-blue-300/50 uppercase tracking-wider font-semibold mb-3">Admin
                            </p>
                            ...
                            <a href="{{ route('users.index') }}"
                                ...
                                <div
                                    class="w-9 h-9 rounded-lg bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <a href="{{ route('reports.index') }}"
                                ...
                                <div
                                    class="w-9 h-9 rounded-lg bg-gradient-to-br from-teal-500 to-emerald-500 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <a href="{{ route('services.index') }}"
                                ...
                                <div
                                    class="w-9 h-9 rounded-lg bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <a href="{{ route('smart-suggestions.index') }}"
                                ...
                                <div
                                    class="w-9 h-9 rounded-lg bg-gradient-to-br from-violet-600 to-fuchsia-600 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <a href="{{ route('field-definitions.index') }}"
                                ...
                                <div
                                    class="w-9 h-9 rounded-lg bg-gradient-to-br from-slate-600 to-slate-800 flex items-center justify-center mr-3 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all">
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="absolute bottom-0 left-0 right-0 p-5 border-t border-white/10 glass-effect">
                <div class="flex items-center">
                    <div
                        class="w-11 h-11 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-xl flex items-center justify-center shadow-lg">
                        <span class="text-white font-bold text-lg">{{ substr(auth()->user()->name, 0, 1) }}</span>
                    </div>
                    <div class="ml-3 flex-1 min-w-0">
                        <p class="text-white font-semibold truncate">{{ auth()->user()->name }}</p>
                        <p class="text-blue-300/60 text-xs">{{ ucfirst(str_replace('_', ' ', auth()->user()->role)) }}
                        </p>
                    </div>
        ...
        <div class="lg:ml-72 transition-all duration-300">
            ...
            <header class="bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-200/50 sticky top-0 z-30">
                <div class="flex items-center justify-between px-4 sm:px-6 py-4">
                    ...
                    <button @click="sidebarOpen = true"
                        class="lg:hidden p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-xl transition-all">
                    ...
                    <div class="flex items-center gap-2 flex-wrap" x-data="{ showDatePicker: false }">
                        <a href="{{ request()->fullUrlWithQuery(['date' => now()->format('Y-m-d')]) }}"
                            class="px-4 py-2 text-sm bg-gradient-to-r from-blue-500 to-indigo-50 text-blue-700 border border-blue-100 rounded-xl hover:bg-blue-100 font-medium shadow-sm transition-all duration-200">
                            Today
                        </a>
                        <a href="{{ request()->fullUrlWithQuery(['date' => now()->subDay()->format('Y-m-d')]) }}"
                            class="px-4 py-2 text-sm bg-gray-50 text-gray-700 border border-gray-200 rounded-xl hover:bg-gray-100 font-medium transition-all duration-200">
                            Yesterday
                        </a>
                        <div class="relative">
                            <input type="date" value="{{ request('date', now()->format('Y-m-d')) }}"
                                onchange="let url = new URL(window.location.href); url.searchParams.set('date', this.value); window.location.href = url.toString();"
                                class="px-4 py-2 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 bg-white hover:bg-gray-50 transition-all duration-200 cursor-pointer shadow-sm">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open"
                                class="flex items-center gap-2 px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-xl transition-all duration-200">
                                <span class="hidden sm:block text-sm font-medium">{{ auth()->user()->name }}</span>
                                <div
                                    class="w-8 h-8 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-lg flex items-center justify-center shadow-sm">
                                    <span
                ...
                @if (session('success'))
                    <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)"
                        ...
                        <button @click="show = false"
                            class="ml-auto text-emerald-600 hover:text-emerald-800 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M6 18L18 6M6 6l12 12" />
                            </svg>
            ...
            <footer class="py-6 px-4 sm:px-6 lg:px-8 border-t border-gray-100 bg-white/30">
                <div
                    class="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-500">
        ...
        <div x-show="showModal" x-transition:enter="transition ease-out duration-300"
            ...
            <div x-show="showModal" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="flex items-center gap-4 mb-6">
                    <div
                        class="w-14 h-14 bg-gradient-to-br from-amber-400 to-orange-500 rounded-xl flex items-center justify-center shadow-lg shadow-orange-500/30 animate-pulse">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-900"
                            x-text="isLoginAlert ? '📅 Today\'s Meetings' : '⏰ Upcoming Meeting!'"></h3>
                        <p class="text-sm text-gray-500"
                            x-text="isLoginAlert ? 'You have meetings scheduled for today' : 'A meeting is starting soon'">
                        </p>
                    </div>
                    <button @click="dismissModal()"
                        class="ml-auto p-2 hover:bg-gray-100 rounded-lg transition-colors">
                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <p class="font-semibold text-gray-900"
                                        x-text="meeting.client_name || 'Unknown Client'"></p>
                                    ...
                                    <div class="flex items-center gap-3 mt-2">
                                        ...
                                        <span
                                            ...
                                            x-text="meeting.type"></span>
                                    </div>
                                    <p x-show="meeting.location" class="text-xs text-gray-500 mt-1"
                                        x-text="'📍 ' + meeting.location"></p>
                                </div>
                                <div x-show="meeting.is_upcoming" class="text-right">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold"
                                        :class="meeting.diff_minutes <= 15 ? 'bg-red-100 text-red-700' : (meeting
                                            .diff_minutes <= 30 ? 'bg-amber-100 text-amber-700' :
                ...
                <div class="mt-6 flex items-center justify-between">
                    ...
                    <button @click="dismissModal()"
                        class="px-5 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold rounded-xl hover:shadow-lg transition-all">
                        Got it!
                    </button>
                </div>
            </div>
                    ...
                    try {
                        ...
                        if (data.alert && data.meetings.length > 0) {
                            ...
                            if (newMeetings.length > 0) {
                                ...
                                localStorage.setItem('notifiedMeetings_' + new Date().toDateString(), JSON.stringify(
                                    this.notifiedMeetings));
                            }
                        }
                    } catch (error) {
